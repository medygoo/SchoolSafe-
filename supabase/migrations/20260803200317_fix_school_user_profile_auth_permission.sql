...
'Creates or updates a SchoolSafe application user. Auth email uniqueness is verified by the server-side invitation workflow; browser callers never read auth.users directly.';
